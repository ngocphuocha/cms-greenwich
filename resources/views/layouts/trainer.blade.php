    ...
    <body>
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavId">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    <li class="nav-item active">
                        <a class="nav-link" href="{{route('trainer.home')}}">Home <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
        ...
        <main>
            <div class="container">
                ...
                <div class="row">
                  <div class="col">
                    <a name="" id="" class="btn btn-primary" href="{{route('trainer.courses.show', \Auth::id())}}" role="button">View course</a>
