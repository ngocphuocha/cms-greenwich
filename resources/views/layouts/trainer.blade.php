...
<body>
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavId">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
          <li class="nav-item active">
            <a class="nav-link" href="{{route('trainer.home')}}"><i class="fa fa-home" aria-hidden="true"> Home</i>
  ...
  <main>
    <div class="container">
      ...
      <div class="row">
        <div class="col">
          <a name="" id="" class="btn btn-primary" href="{{route('trainer.courses.show', \Auth::id())}}"
