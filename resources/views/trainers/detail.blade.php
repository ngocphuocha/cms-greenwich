  ...
  <div class="col">
    <div class="card" style="width: 18rem;">
      ...
      <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item">School: {{$user->education}}</li>
        @endempty
        @empty(!$user->birthday)
        <li class="list-group-item">Birthday: {{$user->birthday}}</li>
        @endempty
        @empty(!$user->pro_lang)
        <li class="list-group-item">Programing laguage: {{$user->pro_lang}}</li>
        @endempty
        @empty(!$user->ielts_score)
        <li class="list-group-item">Ielts Score: {{$user->ielts_score}}</li>
        @endempty
        @empty(!$user->location)
